        ...
        <div class="flex w-full flex-col bg-white  rounded-r-2xl md:w-5/12">
            ...
            <div class="border-b-2">
                <div class="flex items-center p-5">
                    <img src="{{$post->user->image}}" alt="" class="me-5
            ...
            <div class="flex flex-col grow overflow-y-auto">
                <div class="flex items-center p-5">
                    <img src="{{ $post->user->image }}" class="me-5 h-10 w-10 rounded-full">
                    <div>
                ...
                @foreach($post->comments as $comment)
                        <div class="flex items-center px-5 py-1">
                            <img src="{{$comment->user->image}}" alt="" class="h-8 w-8 rounded-full me-5">
                            <div class="me-2">
